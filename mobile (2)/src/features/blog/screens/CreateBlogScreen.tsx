  ...
  const handleSubmit = () => {
    ...
    createPost(apiData, {
      ...
      onError: (err: any) => {
        Alert.alert(
          t("common.error"),
          err?.response?.data?.message || t("blog.failedCreatePost"),
        );
      },
    });
  };
  ...
  return (
    <ThemedView style={[styles.container, { backgroundColor: bg }]}>
      ...
      <View style={[styles.header, { backgroundColor: card }]}>
        ...
        <TouchableOpacity
          onPress={() =>
            Alert.alert(t("blog.drafts"), t("blog.draftsComingSoon"))
          }
        >
          <ThemedText style={[styles.draftsText, { color: primary }]}>
            {t("blog.drafts")}
          </ThemedText>
        </TouchableOpacity>
      </View>
            ...
            <View style={styles.uploadPlaceholder}>
              ...
              >
                ...
                <View
                  style={[
                    styles.plusBadge,
                    { backgroundColor: primary, borderColor: card },
                  ]}
                >
                  <Ionicons name="add" size={10} color="white" />
                </View>
              </View>
              <ThemedText style={[styles.uploadTitle, { color: text }]}>
                {t("blog.addCoverPhoto")}
              </ThemedText>
              <ThemedText style={[styles.uploadSubtitle, { color: muted }]}>
                {t("blog.tapToUpload")}
              </ThemedText>
            </View>
          )}
            ...
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {t(`blog.categories.${cat.toLowerCase()}`, {
                      defaultValue: cat,
                    })}
                  </ThemedText>
                  {isSelected && (
