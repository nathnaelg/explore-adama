...
export default function ExploreScreen() {
  ...
  /* ---------------- state ---------------- */
  const { initialCategoryKey } = useLocalSearchParams<{
  ...
  React.useEffect(() => {
    if (initialCategoryKey && categories) {
      const targetCategory = categories.find((c) =>
        (c.key || c.name)
          .toLowerCase()
          .includes(initialCategoryKey.toLowerCase()),
      );
      if (targetCategory) {
  ...
  const displayCategories = categories
    ? [{ id: "all", name: t("explore.all") }, ...categories]
    : [];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          {displayCategories.map((cat) => {
            const active =
              (selectedCategoryId === null && cat.id === "all") ||
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() =>
                  setSelectedCategoryId(cat.id === "all" ? null : cat.id)
                }
              >
                <ThemedText
                  style={{
        ...
        <View style={styles.filters}>
          {filters.map((filter) => {
            ...
            return (
              ...
              >
                <ThemedText
                  style={{ color: active ? accent : text, fontSize: 14 }}
                >
                  {filter.label}
                </ThemedText>
        ...
        <View style={styles.list}>
          {placesLoading ? (
            ...
            <ThemedText
              style={{ color: muted, textAlign: "center", marginTop: 50 }}
            >
            ...
            places.map((place) => (
              ...
              >
                ...
                <View style={styles.ratingBadgeContainer}>
                  <View style={[styles.ratingBadge, { backgroundColor: card }]}>
                    <Ionicons name="star" size={14} color={primary} />
                    <ThemedText style={{ color: text, fontWeight: "700" }}>
                ...
                <View style={styles.cardBody}>
                  ...
                  <ThemedText style={[styles.cardSubtitle, { color: muted }]}>
