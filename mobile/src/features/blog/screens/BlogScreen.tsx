...
export default function BlogScreen() {
    ...
    // Extract categories from current posts for the filter bar
    const categories = ['all', ...blogService.extractCategoriesFromPosts(blogPosts)];
...
const styles = StyleSheet.create({
    ...
    categoryButton: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 20 },
